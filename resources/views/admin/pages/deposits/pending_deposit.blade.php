...
<div class="card">
    ...
    <div class="card-body table-responsive">
        <table class="table table-striped table-hover table-head-bg-primary mt-4">
            ...
            <tbody>
                @forelse($pendingDeposits as $index => $deposit)
                    <tr>
                        <td>{{ $index + 1 }}</td>
                ...
                @empty
                    <tr><td colspan="10" class="text-center">No pending deposits found.</td></tr>
                @endforelse

            </tbody>
        </table>
        <div class="d-flex justify-content-center">
            {{ $pendingDeposits->links('admin.layouts.partials.__pagination') }}
        </div>
